                ...
                child: Column(
                  ...
                  children: <Widget>[
                    TextFormField(
                      ...
                      validator: (input) =>
                          input.length < 3 ? "Phone number too short" : null,
                      autofocus: true,
                      maxLength: 18,
                      decoration: InputDecoration(
                          ...
                          hintStyle:
                              TextStyle(fontSize: 15.0, color: KWhiteColor)),
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintText: "********",
                          hintStyle:
                              TextStyle(fontSize: 20.0, color: KWhiteColor)),
                    ),
                              ...
                              APIService
                                ...
                                if (value.access_token.isNotEmpty) {
                                  await _storage.write(
                                      key: "token", value: value.access_token);
